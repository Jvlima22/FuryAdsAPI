...
const creativeSeed: Record<string, { brand: string; headline: string; body: string; cta: string; image: string; platform: "google-ads" | "meta-ads"; compliance: ComplianceStatus; violation?: AdCreative["violation"] }> = {
  ...
  "cv-003": {
    ...
    image: "https://images.unsplash.com/photo-1474722883778-792e7990302f?w=1200&q=80&auto=format&fit=crop",
  ...
  "cv-004": {
    ...
    cta: "Inscrever-se",
    image: "https://images.unsplash.com/photo-1553361371-9b22f78e8b1d?w=1200&q=80&auto=format&fit=crop",
  },
  "cv-005": {
    brand: "Vintech", platform: "google-ads", compliance: "ok",
    ...
    cta: "Ver plataforma",
    image: "https://images.unsplash.com/photo-1543418219-44e30b057fea?w=1200&q=80&auto=format&fit=crop",
  },
  "cv-006": {
    ...
    cta: "Conhecer",
    image: "https://images.unsplash.com/photo-1516594915697-87eb3b1c14ea?w=1200&q=80&auto=format&fit=crop",
